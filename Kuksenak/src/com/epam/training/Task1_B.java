...
public class Task1_B {
	...
	//Output menu
	static void outMenu(int myMatrix[][],int size) throws IOException{
		BufferedReader Reader = new BufferedReader (new InputStreamReader (System.in));
		String inputStr;
		int choice;
	...
	//Output matrix
	static void output(int myMatrix[][],int size){
	...
	//1.Sort	
	static void sort(int myMatrix[][],int size) throws IOException{
	...
	//2.Shift to Right
	static void shiftRight(int myMatrix[][],int size) throws IOException{
	...
	static void maxInc(int myMatrix[][],int size) throws IOException{
