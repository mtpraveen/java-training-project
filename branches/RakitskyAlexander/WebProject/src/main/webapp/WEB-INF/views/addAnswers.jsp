...
<head>
	...
	<title><spring:message code="label.title.add" /></title>
</head>

<a href="<c:url value="/"></c:url>">
<spring:message code="label.home"></spring:message> </a>
<a href="<c:url value="/showAnswers"></c:url>">
<spring:message code="label.showAnswer"></spring:message> </a>
...
<h2><spring:message code="label.title.add"/></h2>
...
<c:set var="test1" value="${test}"></c:set>
	<form:form method="post" action="addAnswers" commandName="testing">
<tr>
