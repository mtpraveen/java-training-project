...
public class AccountController {
	...
	public void  createAjax(@RequestParam(value = "name", required = false) String name,
							@RequestParam(value = "email", required = false) String email, HttpServletResponse httpServletResponse) throws IOException {
		JSONSerializer serializer = new JSONSerializer(); 
		HashMap<String, Boolean> map = new HashMap<String, Boolean>();
		if (name != null)
			map.put("nameError", Account.findAccountByName(name) != null);
		if (email != null)
			map.put("emailError", Account.findAccountByEmail(email) != null);
