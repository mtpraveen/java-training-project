...
privileged aspect VoteController_Roo_Controller {
    ...
    public Collection<Account> VoteController.populateAccounts() {
        return Account.findAllAccounts();
    }
    
    @ModelAttribute("answers")
    public java.util.Collection<Answer> VoteController.populateAnswers() {
        return Answer.findAllAnswers();
    }
    
    @ModelAttribute("questions")
    public java.util.Collection<Question> VoteController.populateQuestions() {
        return Question.findAllQuestions();
    }
    
    @ModelAttribute("votes")
    public java.util.Collection<Vote> VoteController.populateVotes() {
        return Vote.findAllVotes();
    }
    
    void VoteController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("vote_votedate_date_format", DateTimeFormat.patternForStyle("S-", LocaleContextHolder.getLocale()));
    }
