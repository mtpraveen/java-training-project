...
privileged aspect Category_Roo_Entity {
    ...
    declare @type: Category: @Table(name = "categories");
    ...
    public static long Category.countCategories() {
        return entityManager().createQuery("SELECT COUNT(o) FROM Category o", Long.class).getSingleResult();
    }
    
    public static long Category.countQuestions(Category category) {
    ...
    public static List<Question> Category.findQuestionEntries(Category category, int firstResult, int maxResults) {
    ...
    public static List<Category> Category.findAllCategories() {
