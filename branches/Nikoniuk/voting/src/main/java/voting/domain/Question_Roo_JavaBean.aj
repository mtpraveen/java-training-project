...
privileged aspect Question_Roo_JavaBean {
    ...
    public boolean Question.isMultipleChoice() {
    ...
    public boolean Question.isVisible() {
        return this.visible;
    }
    ...
    public Date Question.getCreationDate() {
        return this.creationDate;
    }
    
    public void Question.setCreationDate(Date creationDate) {
