...
import voting.domain.AnswerDataOnDemand;
...
privileged aspect AnswerIntegrationTest_Roo_IntegrationTest {
    ...
    public void AnswerIntegrationTest.testCountAnswers() {
        ...
        long count = voting.domain.Answer.countAnswers();
    ...
    public void AnswerIntegrationTest.testFindAnswer() {
        voting.domain.Answer obj = dod.getRandomAnswer();
        ...
        obj = voting.domain.Answer.findAnswer(id);
    ...
    public void AnswerIntegrationTest.testFindAllAnswers() {
        ...
        java.util.List<voting.domain.Answer> result = voting.domain.Answer.findAllAnswers();
    ...
    public void AnswerIntegrationTest.testFindAnswerEntries() {
        ...
        java.util.List<voting.domain.Answer> result = voting.domain.Answer.findAnswerEntries(0, (int) count);
    ...
    public void AnswerIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyAnswer(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        voting.domain.Answer merged = (voting.domain.Answer) obj.merge();
        obj.flush();
    ...
    public void AnswerIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Answer' failed to initialize correctly", dod.getRandomAnswer());
        voting.domain.Answer obj = dod.getNewTransientAnswer(Integer.MAX_VALUE);
    ...
    public void AnswerIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Answer' with identifier '" + id + "'", voting.domain.Answer.findAnswer(id));
    }
