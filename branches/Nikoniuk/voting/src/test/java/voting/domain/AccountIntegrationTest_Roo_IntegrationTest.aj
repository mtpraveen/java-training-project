...
privileged aspect AccountIntegrationTest_Roo_IntegrationTest {
    ...
    public void AccountIntegrationTest.testCountAccounts() {
        ...
        long count = voting.domain.Account.countAccounts();
    ...
    public void AccountIntegrationTest.testFindAccount() {
        voting.domain.Account obj = dod.getRandomAccount();
        ...
        obj = voting.domain.Account.findAccount(id);
    ...
    public void AccountIntegrationTest.testFindAllAccounts() {
        ...
        java.util.List<voting.domain.Account> result = voting.domain.Account.findAllAccounts();
    ...
    public void AccountIntegrationTest.testFindAccountEntries() {
        ...
        java.util.List<voting.domain.Account> result = voting.domain.Account.findAccountEntries(0, (int) count);
    ...
    public void AccountIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyAccount(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        voting.domain.Account merged = (voting.domain.Account) obj.merge();
        obj.flush();
    ...
    public void AccountIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Account' failed to initialize correctly", dod.getRandomAccount());
        voting.domain.Account obj = dod.getNewTransientAccount(Integer.MAX_VALUE);
    ...
    public void AccountIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Account' with identifier '" + id + "'", voting.domain.Account.findAccount(id));
    }
