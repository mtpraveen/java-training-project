...
<div class="content">
  ...
  <div id="nav">
	...
	<li><a href='<c:url value="/find"/>'>Find</a></li>
      ...
      <li id="current"><a href='<c:url value="/contact" />'>Contact</a></li>
  ...
  <div class="main_content">
   ...
   <h4>
    ...
    <div class="sd_left">
      <div class="text_padding">
        <h2>Contact</h2>
        Исполнитель проекта: Гумянко Сергей Николаевич<br />
        Место обучения: Брестский Государственный Технический Университет<br />
        Специальность: Автоматизированные системы обработки информации<br />
        Телефон: +375(29)5240526<br />
        Email:citybrest@mail.ru<br />
