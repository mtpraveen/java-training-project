...
public class PeriodicalSystem {
	...
	public static void main(String[] args) {
		...
		Date date1=new Date(11,4,8);
		@SuppressWarnings("deprecation")
		Date date2=dr.pay(new Date(11,4,12));
...
class Admin{
	...
	private void giveOrder(Order order){
		System.out.println("Admin "+name+" give  this order!");
	}
	private void toBlackList(Order order){
		System.out.println("Admin "+name+" send to Black List  this order!");
	}
}
//Reader Class
class Reader{
...
class Order{
	...
	@Override
	public String toString() {
		return "Order : [Reader= "+readerOrder.getName()+" \n\tlistOrder=" + listOrder + " \n\tsumOrder=" + sumOrder+"$"
				+ "\n\tdateOrder=" + dateOrderWasPaid + "\n\tdatetoPayOrder="
				+ datetoPayOrder + "]";
	}
