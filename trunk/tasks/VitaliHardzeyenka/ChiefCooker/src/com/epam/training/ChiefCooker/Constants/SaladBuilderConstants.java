...
public class SaladBuilderConstants {
	...
	public final static String PEPPER = "Pepper";
	public final static String TOMATO = "Tomato";
	public final static String SQUASH = "Squash";
	public final static String NO_SUCH_VEGETABLE_MESSAGE = "There is no such vegetable in the hierarchy";
	public final static char PEPPER_NUMBER = '1';
	public final static char TOMATO_NUMBER  = '2';
	public final static char SQUASH_NUMBER = '3';
	public final static char YES_CHAR = 'y';
	public final static char NO_CHAR = 'n';
}
