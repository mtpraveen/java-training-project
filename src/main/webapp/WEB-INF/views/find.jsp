...
<head>
<title><spring:message code="label.finder" /></title>
...
<div class="content">
  ...
  <div id="nav">
   ...
   <sec:authorize ifAllGranted="ROLE_USER">
	<li><a href='<c:url value="/index"/>'>Auctions</a></li>
  	...
  	<sec:authorize ifAllGranted="ROLE_USER">
	<li id="current"><a href='<c:url value="/find"/>'>Find</a></li>
	</sec:authorize>
  ...
  <div class="main_content">
    ...
    <div class="sd_left">
      ...
      <table>
	<tr>
		<td><h2>Введите <spring:message code="label.firstname" /></h2>
		</td>
	...
	<form:form method="post" action="setTovars" commandName="tovar">
		...
		<tr>
			<td><form:input path="name" />&nbsp;<input type="submit" value="Find" />
			</td>
	...
	<c:if test="${ empty tovarsName }"><br/>
		&nbsp;<spring:message code="label.emptyList" /><br/>
	</c:if>
	<c:if test="${! empty tovarsName}">
		<table>
			<tr>
				
						<td><h4><spring:message code="label.firstname" /></h4>
				</td>
				<td><h4><spring:message code="label.category" /></h4>
				</td>
				<td><h4><spring:message code="label.price" /></h4>
				</td>
				<td><h4><spring:message code="label.user" /></h4>
				</td>
			</tr>
